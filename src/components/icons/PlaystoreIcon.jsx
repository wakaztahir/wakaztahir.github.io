...
function PlayStoreIcon(props) {
    return (<material_1.SvgIcon viewBox="-4.12599 -7.65905 35.75858 45.9543" version="1.1" {...props}>
      <defs id="defs38">
      ...
      <g transform="translate(.004)" id="g58">
        <g id="g56">
          ...
          <path id="path52" d="M26.25 16.86l-5.94 3.38.11.11L26.25 17a2.11 2.11 0 001.25-1.72 2.21 2.21 0 01-1.25 1.58z" className="cls-7"/>
