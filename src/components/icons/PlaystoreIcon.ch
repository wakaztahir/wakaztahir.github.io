            ...
            <g transform="translate(.004)">
                <g>
                    ...
                    <path
                          ...
                          fill="url(#linear-gradient-2-play)" />
                    <path d="M20.42 20.35l-5-5L.55 30.16a2 2 0 002.45.07l17.39-9.88"
                          fill="url(#linear-gradient-3-play)" />
                    <path d="M20.42 10.29L3 .4A1.93 1.93 0 00.55.48l14.84 14.84z"
                          fill="url(#linear-gradient-4-play)" />
                    <path d="M20.31 20.24L3 30.06a2 2 0 01-2.39 0l-.09.09.09.09a2 2 0 002.39 0l17.39-9.88z"
                          opacity=".1" />
                    <path d="M.55 30A2.43 2.43 0 010 28.32v.17a2.41 2.41 0 00.55 1.67l.09-.09z"
                          opacity=".07" />
                    <path
